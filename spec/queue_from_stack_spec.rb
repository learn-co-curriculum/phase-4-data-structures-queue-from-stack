# require '../lib/queue_from_stack.rb'

RSpec.describe 'MyQueue' do

  describe '#initialize' do
    it 'creates two instances of the MyStack class' do
      queue = MyQueue.new()
      expect(queue.instance_variable_get(:@s1)).to be_a MyStack
      expect(queue.instance_variable_get(:@s2)).to be_a MyStack
    end
